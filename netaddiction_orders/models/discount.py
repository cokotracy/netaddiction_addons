...
class Discount(models.Model):
	...
	res_model = field.Char(string="Modello Riferimento", help="""inserire il nome esatto del modello di riferimento, vuoto se non 
...
class OrdersOrderLine(models.Model):
    ...
    discount_total = field.Float(string="Sconto totale", compute="_compute_discount")
