...
class OpSettings(models.Model):
    ...
    netaddiction_op_type = fields.Selection(string="Tipo di Operazione",selection=[('reverse_scrape','Reso Difettati'),('reverse_resale','Reso Rivendibile'),('reverse_supplier','Reso a Fornitore')])
